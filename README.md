...
|---------|------|-------------|
| 4.3.1 | 2026-03-19 | Add framework-limitation rebuttal rule to `docs/CHECKLISTS.md`: reviewers must accept explicit framework-constraint rebuttals, preventing REVIEW_BLOCKED loops on unavoidable library constraints (e.g. Starlette multipart). |
